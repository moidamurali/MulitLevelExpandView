...
public class TreeViewActivity extends Activity {
    ...
    private void initializeStaticData(){
        ...
        //Add outermost nodes
        Elements.ElementsData e1 = new Elements.ElementsData("Andhra Pradesh", Elements.ElementsData.TOP_LEVEL, ""+0, Elements.ElementsData.NO_PARENT, true, false);

        //Adding Layer 1 Nodes
        Elements.ElementsData e2 = new Elements.ElementsData("VZM District", Elements.ElementsData.TOP_LEVEL + 1, ""+1, e1.getId(), true, false);
        //Adding Layer 2 Nodes
        Elements.ElementsData e3 = new Elements.ElementsData("NelliMarla MD", Elements.ElementsData.TOP_LEVEL + 2, ""+2, e2.getId(), true, false);
        //Adding Layer 3 Nodes
        Elements.ElementsData e4 = new Elements.ElementsData("Moida", Elements.ElementsData.TOP_LEVEL + 3, ""+3, e3.getId(), false, false);

        //Adding Layer 1 Nodes
        Elements.ElementsData e5 = new Elements.ElementsData("VZM District", Elements.ElementsData.TOP_LEVEL + 1, ""+4, e1.getId(), true, false);
        //Adding Layer 2 Nodes
        Elements.ElementsData e6 = new Elements.ElementsData("Gurla MD", Elements.ElementsData.TOP_LEVEL + 2, ""+5, e5.getId(), true, false);
        //Adding Layer 3 Nodes
        Elements.ElementsData e7 = new Elements.ElementsData("Kella", Elements.ElementsData.TOP_LEVEL + 3, ""+6, e6.getId(), false, false);

        //Adding Layer 1 Nodes
        Elements.ElementsData e8 = new Elements.ElementsData("India", Elements.ElementsData.TOP_LEVEL + 1, ""+7, e1.getId(), false, false);

        //Add outermost nodes
        Elements.ElementsData e9 = new Elements.ElementsData("India", Elements.ElementsData.TOP_LEVEL, ""+8, Elements.ElementsData.NO_PARENT, true, false);
        //Adding Layer 1 Nodes
        Elements.ElementsData e10 = new Elements.ElementsData("Vizag", Elements.ElementsData.TOP_LEVEL + 1, ""+9, e9.getId(), true, false);
        //Adding Layer 2 Nodes
